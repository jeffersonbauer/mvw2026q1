...
window.MVW_DATA = {
  ...
  companies: {
    mvw: {
      ...
      // Risks — verbatim language from FY2025 10-K Item 1A; severity / likelihood are analyst-coded overlays
      risks: [
        ...
        { title: "Macroeconomic & policy uncertainty", severity: 4, likelihood: 4, verbatim: "Uncertainty in the current global macroeconomic environment created by rapid governmental policy and regulatory changes could negatively impact our business.", source: "10-K FY2025, Item 1A", note: "Q1 2026 securitization completed 'in the midst of market volatility and increasing uncertainty' (Jason Marino, Q1 call)" },
        ...
        { title: "Default rates above projections", severity: 4, likelihood: 3, verbatim: "If default rates increase beyond current projections and result in higher than expected foreclosure activity, our results of operations would be adversely affected.", source: "10-K FY2025, Item 1A", note: "Q1 2026: defaults unchanged YoY; sales reserve at 12.3% (down sequentially); 120-day delinquency +17 bps YoY but down 45 bps vs. 2024" },
        ...
        { title: "Spanish timeshare litigation", severity: 3, likelihood: 4, verbatim: "Spanish court rulings voiding certain timeshare contracts have increased our exposure to litigation that may materially adversely affect our business and financial condition.", source: "10-K FY2025, Item 1A" },
        { title: "Turnaround execution / sales-team transition", severity: 4, likelihood: 3, verbatim: "Effects of steps we have taken and may continue to take to reduce operating costs and accelerate growth and profitability.", source: "10-K FY2025, Item 1A (forward-looking factors)", note: "ANALYST OVERLAY: New CEO/COO/CSMO team must execute Inner Circle launch, loyalty-tier rollout, and tour-logistics deployment on accelerated timeline. Operating expenses up Q1 to support these initiatives." }
      ],
    ...
    hgv: {
      ...
      risks: [
        ...
        { title: "Brand-conversion execution risk", severity: 3, likelihood: 3, verbatim: "Our ability to use the Hilton brands and trademarks and rebrand the Diamond and Bluegreen businesses and properties.", source: "10-K FY2025, Item 1A" },
        { title: "Diamond + Bluegreen integration", severity: 4, likelihood: 3, verbatim: "Our ability to integrate the Diamond and the Bluegreen businesses successfully and effectively manage our expanded operations resulting from both the Diamond Acquisition and the Bluegreen Acquisition.", source: "10-K FY2025, Item 1A", note: "Q1 2026 contract-sales decline reflects lapping HGV Max Bluegreen launch — VPG -8% YoY" },
        { title: "Receivable defaults", severity: 4, likelihood: 4, verbatim: "Our limited underwriting standards and a possible decline in the default rates or other credit metrics underlying our timeshare financing receivables.", source: "10-K FY2025, Item 1A", note: "Q1 2026 default rate 10.1% — slight YoY improvement; loan loss provision rate 14.9% sequentially (down from 18%)" },
        { title: "Substantial indebtedness / variable-rate", severity: 4, likelihood: 3, verbatim: "Our substantial indebtedness and other contractual obligations, restrictions imposed on us by certain of our debt agreements and instruments and our variable rate indebtedness which subjects us to interest rate risk.", source: "10-K FY2025, Item 1A", note: "Q1 2026: $4.8B corporate debt + $2.6B securitized; net leverage 3.9x" },
        ...
        { title: "VPG normalization", severity: 3, likelihood: 4, verbatim: "Variations in demand for vacation ownership and exchange products and services.", source: "10-K FY2025, Item 1A (forward-looking)", note: "ANALYST OVERLAY: Q1 2026 VPG -8.1% YoY; mgmt expects continued VPG declines through Q2/Q3 before Q4 inflection" }
      ],
    ...
    tnl: {
      ...
      risks: [
        ...
        { title: "VO receivables portfolio", severity: 4, likelihood: 4, verbatim: "We are subject to risks related to our vacation ownership receivables portfolio.", source: "10-K FY2025, Item 1A", note: "Q1 2026: loan loss provision $100M (vs. $91M Q1'25); allowance $646M; 91-120 day delinquency 1.4%" },
        ...
        { title: "Indebtedness & cost of capital", severity: 3, likelihood: 3, verbatim: "We are subject to certain risks related to our indebtedness, hedging transactions, securitization of certain of our assets, surety bond requirements, the cost and availability of capital and the extension of credit by us.", source: "10-K FY2025, Item 1A", note: "Q1 2026: $3.6B corporate + $2.1B securitized; leverage <3.2x covenant" },
        { title: "Regulatory compliance", severity: 3, likelihood: 4, verbatim: "Our business is subject to extensive regulation and the cost of compliance or failure to comply with such regulations may adversely affect us.", source: "10-K FY2025, Item 1A" },
        ...
        { title: "RCI exchange member-base decline", severity: 3, likelihood: 4, verbatim: "Variations in demand for vacation ownership and exchange products and services.", source: "10-K FY2025, Item 1A (forward-looking)", note: "ANALYST OVERLAY: T&M segment Q1 2026 revenue -8% YoY; avg RCI members -2% YoY to 3.29M" }
      ],
